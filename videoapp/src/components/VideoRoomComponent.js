...
class VideoRoomComponent extends Component {
	...
	let conferenceName = this.props.conferenceName ? this.props.conferenceName : 'SessionA';        
let userName = this.props.user ? this.props.user : 'Visiondrill_U' + Math.floor(Math.random() * 100);
        this.state = {
    ...
    connect(token) {
        this.state.session
            .connect(
                token, { clientData: this.state.myUserName },
            )
            .then(() => {
                this.connectWebCam();
            })
    ...
    leaveSession() {
        ...
        this.setState({
            ...
            myUserName: 'Visiondrill_U' + Math.floor(Math.random() * 100),
            localUser: undefined,
        });
	...
	let src = '/notification_sound.wav';
    ...
    render() {
	const conferenceName = this.state.conferenceName;
